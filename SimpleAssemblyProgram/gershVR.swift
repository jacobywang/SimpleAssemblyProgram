...
class VirtualMachine{
    ...
    func runProgram(_ input: String)->String{
        ...
        while pointer < binary.count && halted == false{
            ...
            case 51://readln
                ...
                pointer += 3
            case 52://brk
                //dont have debugger---how would you 'break into it'?
                pointer += 1
            case 53://movrx
...
func brk() {
    ...
    let parts = splitStringintoLines(expression: sym).map( {splitStringintoParts(expression: $0)} )
    for i in parts {
        symbols[i[0]] = Int(i[1])
    }
